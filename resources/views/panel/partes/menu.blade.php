          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="">Mostrar Estudiantes</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="">Mostrar Docentes</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="">Mostrar Materias</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="">Mostrar Carreras</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="">Mostrar Semestres</a></li>
